...
const BentoGrid = ({ children, className, ...props }: BentoGridProps) => {
  return (
    <div
      className={cn(
        "grid w-full auto-rows-fr grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3",
        className,
      )}
      {...props}
    >
...
const BentoCard = ({
  ...
  <div
    key={name}
    className={cn(
      "group relative col-span-1 flex h-full min-h-[20rem] min-w-0 flex-col overflow-hidden rounded-xl",
      // light styles
